...
GRANT ALL ON discord_translator_bot.channels TO 'discord-translator-bot'@'localhost';
GRANT ALL ON discord_translator_bot.messages TO 'discord-translator-bot'@'localhost';
Flush Privileges;